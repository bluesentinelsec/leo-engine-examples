...
static bool demo_setup(leo_GameContext *ctx) {
    ...
    KeyDisplay keys[] = {
        {KEY_W, "W", 100, 150}, {KEY_A, "A", 50, 200}, {KEY_S, "S", 100, 200}, {KEY_D, "D", 150, 200},
        {KEY_UP, "↑", 300, 150}, {KEY_LEFT, "←", 250, 200}, {KEY_DOWN, "↓", 300, 200}, {KEY_RIGHT, "→", 350, 200},
        {KEY_SPACE, "SPACE", 200, 250}, {KEY_RETURN, "ENTER", 300, 250},
        {KEY_LSHIFT, "SHIFT", 50, 300}, {KEY_LCTRL, "CTRL", 150, 300},
        {KEY_Q, "Q", 50, 150}, {KEY_E, "E", 150, 150},
        {KEY_TAB, "TAB", 400, 150}, {KEY_ESCAPE, "ESC", 400, 100}
    };
...
static void demo_render_ui(leo_GameContext *ctx) {
    ...
    snprintf(state_info, sizeof(state_info), 
             "WASD: W=%d A=%d S=%d D=%d | Arrows: ↑=%d ←=%d ↓=%d →=%d | Space=%d Enter=%d",
             leo_IsKeyDown(KEY_W), leo_IsKeyDown(KEY_A), leo_IsKeyDown(KEY_S), leo_IsKeyDown(KEY_D),
             leo_IsKeyDown(KEY_UP), leo_IsKeyDown(KEY_LEFT), leo_IsKeyDown(KEY_DOWN), leo_IsKeyDown(KEY_RIGHT),
             leo_IsKeyDown(KEY_SPACE), leo_IsKeyDown(KEY_RETURN));
