...
static void demo_update(leo_GameContext *ctx)
{
    ...
    // Clamp zoom
    if (state->camera.zoom < 0.1f)
        state->camera.zoom = 0.1f;
    if (state->camera.zoom > 5.0f)
...
static void demo_render_ui(leo_GameContext *ctx)
{
    ...
    case 0: // Filled shapes showcase - SPECTACULAR!
    {
        ...
        for (int i = 0; i < 12; i++)
        {
            ...
            leo_Color color = {(int)(255 * (0.5f + 0.5f * sinf(t + (float)i))),
                               (int)(255 * (0.5f + 0.5f * cosf(t * 1.3f + (float)i))), 255, 180};
        ...
        for (int layer = 0; layer < 3; layer++)
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                leo_Color color = {100 + layer * 50, 255 - layer * 60, 150 + layer * 30, 200 - layer * 40};
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            leo_Color color = {(int)(255 * (0.3f + 0.7f * sinf(t + (float)i * 0.7f))),
                               (int)(255 * (0.3f + 0.7f * cosf(t * 1.1f + (float)i * 0.7f))),
                               (int)(255 * (0.3f + 0.7f * sinf(t * 0.8f + (float)i * 0.7f))), 160};
        ...
        for (int i = 0; i < 15; i++)
        {
            ...
            leo_Color fillColor = {50 + i * 10, 150 + (int)(50 * sinf(cascade)), 255 - i * 8, 255 - i * 15};
    ...
    case 1: // Outline shapes showcase - GEOMETRIC MADNESS!
    {
        ...
        for (int wave = 0; wave < 3; wave++)
        {
            ...
            for (int i = 1; i <= 12; i++)
            {
                ...
                leo_Color color = {(int)(255 * (0.4f + 0.6f * sinf(t + (float)i * 0.2f + (float)wave))),
                                   100 + i * 12 + wave * 30, 255 - i * 15, 200};
        ...
        for (int i = 0; i < 20; i++)
        {
            ...
            leo_Color color = {255, (int)(255 * (0.3f + 0.7f * sinf(t + (float)i * 0.5f))),
                               100 + (int)(100 * cosf(t * 1.2f + (float)i * 0.5f)), 180};
        ...
        for (int layer = 0; layer < 4; layer++)
        {
            ...
            for (int copy = 0; copy < 6; copy++)
            {
                ...
                leo_Color color = {255 - layer * 40 - copy * 20, 150 + layer * 20, 255 - copy * 30, 150 - layer * 20};
        ...
        for (int i = 0; i < 25; i++)
        {
            ...
            if (size > 5)
            {
                leo_Color color = {100 + i * 6, 255 - i * 8, 100 + (int)(100 * sinf(t + (float)i * 0.3f)), 255 - i * 8};
    ...
    case 2: // Mixed shapes animation - PARTICLE EXPLOSION!
    {
        ...
        for (int layer = 0; layer < 4; layer++)
        {
            ...
            for (int i = 0; i < numOrbiters; i++)
            {
                ...
                leo_Color color = {(int)(255 * (0.4f + 0.6f * sinf(angle + t))),
                                   (int)(255 * (0.4f + 0.6f * cosf(angle * 1.3f + t))), 255 - layer * 40,
                                   200 - layer * 30};
        ...
        leo_Color morphColor = {(int)(255 * (0.6f + 0.4f * sinf(t * 2.0f))),
                                (int)(255 * (0.6f + 0.4f * cosf(t * 1.7f))),
                                (int)(255 * (0.6f + 0.4f * sinf(t * 2.3f))), 180};
        ...
        for (int burst = 0; burst < 3; burst++)
        {
            ...
            if (burstTime < 3.0f)
            {
                ...
                for (int p = 0; p < 30; p++)
                {
                    ...
                    if (size > 1)
                    {
                        leo_Color pColor = {(int)(255 * life), (int)(255 * life * (0.5f + 0.5f * sinf((float)p))),
                                            (int)(255 * life * (0.5f + 0.5f * cosf((float)p))), (int)(255 * life)};
    ...
    case 3: // Stress test - ABSOLUTE CHAOS!
    {
        ...
        for (int x = 0; x < 30; x++)
        {
            for (int y = 0; y < 20; y++)
            {
                ...
                // Dynamic colors
                leo_Color color = {(int)(128 + 127 * sinf(phase)), (int)(128 + 127 * cosf(phase * 1.3f)),
                                   (int)(128 + 127 * sinf(phase * 0.7f + wave)), 200 + (int)(55 * wave)};
                ...
                case 1:
                    ...
                    break;
                case 2:
                    leo_DrawTriangleFilled(posX, posY - baseSize, posX - baseSize, posY + baseSize, posX + baseSize,
                                           posY + baseSize, color);
                    break;
                case 3:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    leo_DrawTriangle(posX, posY - baseSize, posX - baseSize, posY + baseSize, posX + baseSize,
                                     posY + baseSize, color);
                    break;
                }
            }
        ...
        for (int layer = 0; layer < 5; layer++)
        {
            ...
            for (int copy = 0; copy < 3; copy++)
            {
                ...
                leo_Color color = {255 - layer * 30, 100 + layer * 30, 255 - copy * 60, 80 - layer * 10};
                leo_DrawPoly(polyPoints, sides, color);
            }
        }
        ...
        for (int chaos = 0; chaos < 100; chaos++)
        {
            ...
            leo_Color chaosColor = {
                (int)(255 * (0.5f + 0.5f * sinf(seed * 2.1f))), (int)(255 * (0.5f + 0.5f * cosf(seed * 1.7f))),
                (int)(255 * (0.5f + 0.5f * sinf(seed * 2.9f))), 100 + (int)(100 * (0.5f + 0.5f * sinf(seed)))};
    ...
    // Camera info
    char cameraText[128];
    snprintf(cameraText, sizeof(cameraText), "Camera: (%.0f, %.0f) Zoom: %.2f", state->camera.target.x,
             state->camera.target.y, state->camera.zoom);
